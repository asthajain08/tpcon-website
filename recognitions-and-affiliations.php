		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Recognitions and Affiliations</h1>
							<ul>
								<li>
									<a class="active" href="index2.html">About Us</a>
								</li>
								<li>Recognitions and Affiliations</li>
							</ul>
					</div>
			</div>
			<!-- Breadcrumbs End -->
			...
			<div id="rs-about" class="rs-about style1 pt-100 pb-100 md-pt-70 md-pb-70">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="sec-title">
								<div class="sub-title orange">Recognitions and Affiliations</div>
						        <h3 class="title mb-17">Welcome to Teerthanker Parasvnath College of Nursing</h3>
							   
                                <ul>
                                    <li>Affiliated to Teerthanker Mahaveer University, Moradabad</li>
                                    <li>Recognised by Government of Uttar Pradesh</li>
                                    <li>Recognised by Uttar Pradesh State Nursing Council</li>
                                    <li>Recognised by the Indian Nursing Council</li>
                                </ul>
