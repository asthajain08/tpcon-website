				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/antiragging.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								...
								<div class="bold-text mb-22">"Ragging Free Campus"</div>
								<div class="desc">TPCON campus assures safe and secure learning environment. Ragging is a criminal offence and serious legal actions will be taken by the institution.</div>
							</div>
						</div>
					</div>
				</div>
