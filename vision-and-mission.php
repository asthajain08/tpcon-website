				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/vm.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								<div class="sub-title orange">Vision And Mission</div>
						        <h3 class="title mb-17">Welcome to Teerthanker Parasvnath College of Nursing</h3>
                                <ul>
                                    <li>
                                        <h3>Vision:-</h3>
                                        <p>To be internationally recognized as a premier institution of excellence providing quality education and consultation services globally.</p>
                                        <h3>Mission:-</h3>
                                        <p>Our endeavor is to import knowledge and develop critical skills necessary to succeed both in professional and personal life by promoting learning supported by world-class faculty, infrastructure, technology, curricula and collaborative teaching and research with premier institutions in India and abroad.</p>
