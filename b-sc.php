...
<div class="main-content">
	...
	<div class="rs-breadcrumbs breadcrumbs-overlay">
		...
		<div class="breadcrumbs-text white-color">
			<h1 class="page-title">B.Sc Nursing</h1>
			<ul>
				<li>
					<a class="active" href="index.html">Programmes</a>
				</li>
				<li>B.Sc Nursing</li>
			</ul>
		</div>
		...
		<div class="container d-flex justify-content-center align-items-center" >
			<div class="row align-items-center">
					...
					<div class="col-lg-12 ">
						...
						<div class="sec-title">
							<div class="sub-title orange">Programmes</div>
							<h3 class="title mb-17">Welcome to Teerthanker Parasvnath College of Nursing</h3>
							<div class="bold-text mb-22">"We provide a quality education. "</div>
							<div class="desc">The B.Sc. nursing degree program is a four-year fulltime program
								comprising eight semesters, which prepares a student to become a registered
								nurse qualified to practice in a variety of settings in either public/
								government or private healthcare settings. It adopts credit system and Semester
								system as per UGC guidelines. The program encompasses foundational, core and
								elective courses. The choice-based system is applicable to electives only and is
								offered in the form of modules. Modular learning is also integrated in the
								foundational as well as core courses that are mandatory.</div>
							<br>
							<table>
								<tr>
									<td><b>Duration</td>
								...
								<tr>
									<td><b>Criteria</td>
									<td>10+2 in PCB with English and minimum 50% aggregate marks in PCB.</td>
								</tr>
								<tr>
									<td><b>Fee Structure</td>
									<td>68,400/- (per sem)</td>
								</tr>
								<tr>
