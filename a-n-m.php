		...
		<div class="container d-flex justify-content-center align-items-center">
			<div class="row align-items-center">
				...
				<div class="col-lg-12 ">
						...
						<div class="desc">The A.N.M nursing degree program is a two year fulltime program
							comprising four semesters, which prepares a student to become a registered nurse
							qualified to practice in a variety of settings in either public/ government or
							private healthcare settings. It adopts credit system and Semester system as per UGC
							guidelines. The program encompasses foundational, core and elective courses. The
							choice-based system is applicable to electives only and is offered in the form of
							modules. Modular learning is also integrated in the foundational as well as core
							courses that are mandatory.</div>
						<br>
						<table>
							<tr>
								<td><b>Duration</td>
