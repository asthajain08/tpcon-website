		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Transportation Facilities</h1>
							<ul>
								<li>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/transport.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								...
								<div class="bold-text mb-22">"We provide a first-class Transportation System."</div>
								<div class="desc">TPCON has arranged a pick and drop transportation facility to students within a radius of about 100Km from adjoining areas of the city of Moradabad. The University also maintains ambulances for medical emergencies. In addition, assorted utility vehicles are at the disposal of departments across campus. It presently maintains 54 Buses, 17 Cars, 5 Ambulances including 2 Critical Care Ambulances, 4 Small Trucks for carriage and 2 Tractors with Trolleys and 2 Tankers for agriculture and plantation purposes in the campus.</div>
							</div>
						</div>
					</div>
				</div>
