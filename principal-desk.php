		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Message from the Principal's desk</h1>
							<ul>
								<li>
									<a class="active" href="index.html">About Us</a>
								</li>
								<li>Message from the Principal's desk</li>
							</ul>
					</div>
			</div>
			<!-- Breadcrumbs End -->
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/principal.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								<div class="sub-title orange">About TPCON</div>
						        <h3 class="title mb-17">Welcome to Teerthanker Parasvnath College of Nursing</h3>
								<div class="bold-text mb-22">‘Flower leaves part of its fragrance in the hand that bestows them.’</div>
								<div class="desc">The mind is not a vessel to be filled but a fire to be kindled. A significant journey of thousand miles often begins with a single step. We offer a safe and invigorating environment to our budding nurses at TPCON, to evolve, explore and expand in the field of Nursing profession. The college aims to ignite the desire to learn lifelong.<br>Since we are concerned with the success of the students, you will find committed faculties who are well-versed to academic excellence in offering a typical learning environment for students. The college features a well-developed infrastructure in accordance with nursing council standards, a knowledgeable and committed teaching staff, an updated, well-equipped laboratory, and transportation services. Students have access to extracurricular activities and sporting events, and they benefit greatly from their time spent in the parent hospital.<br>I extend a warm welcome to all the incoming nursing students and bestow upon them my best wishes for academic success as they leave our institute to pursue successful careers as nurses.<br> <br>I hope the best for you.<br><br>Prof. Sheuli Sen<br>Principal</div>
							</div>
						</div>
					</div>
				</div>
