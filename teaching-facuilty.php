		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Teaching Facuilites</h1>
							<ul>
								<li>
									<a class="active" href="index.html">Why TPCON</a>
								</li>
								<li>Teaching Facuilites</li>
							</ul>
					</div>
			</div>
			<!-- Breadcrumbs End -->
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/faculty.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								...
								<div class="bold-text mb-22">The art of teaching is the art of assisting discovery.</div>
								<div class="desc">We have highly qualified and dedicated teaching faculties. All the faculty team put collective efforts to fulfil the vision and mission of the institute. We believe in overall development of our students not just academic excellence.</div>
							</div>
						</div>
					</div>
				</div>
