		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Hostels (Boys/Girls)</h1>
							<ul>
								<li>
									<a class="active" href="index.html">Why TPCON</a>
								</li>
								<li>Hostels (Boys/Girls)</li>
							</ul>
					</div>
			</div>
			<!-- Breadcrumbs End -->
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/hostel.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								...
								<div class="bold-text mb-22">HOSTEL LIFE IS A FIRST STAGE OF LIFE.</div>
								<div class="desc">We call our hostels home for students. The hostels at TMU are a home away from home. The onus of developing the student academically, strengthening their culture, taking care of their physical fitness, all lie on this vital microstructure of the University. Life in TMU hostel is a steppingstone to further independence, an essential right for many, enabling them to reach out to their destiny. The University houses five hostels in its campus- 2 for boys and 3 for girls. The hostel rooms are spacious, clean, and well maintained with attached bathrooms. The rooms are available on single occupancy basis as well as on sharing basis.Water purifiers and water coolers are installed to provide potable water. Laundry facility is available in-house with commercial washing machine and tumbler drier. A dedicated team of wardens and caretakers helps and resolve the problems of the boarders. Students are advised to comply with rules and regulations of the University hostels.</div>
							</div>
						</div>
					</div>
				</div>
