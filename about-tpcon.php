				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/tpcon.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								...
								<div class="bold-text mb-22">Teerthanker Parshvanath College of Nursing, Amroha was established in the year 2010 under the Teerthanker Institute of Management and Technology (Society) with an aim to provide quality nursing education. We believe, education does not lie in the quantification of knowledge, but it lies in the quality of the knowledge. </div>
								<div class="desc">Quality education is not just good academic results but also the spiritual, mental, and physical development of the students which will transform their character and become nation building citizens for India. The Teerthanker Parshvanath College of Nursing tries to give students practical experience by exposing them to a wide range of cases in technologically sophisticated clinical settings at hospitals and emphasizing the significance of upholding the highest professional standards in patient care.</div>
							</div>
						</div>
					</div>
				</div>
