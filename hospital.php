		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs breadcrumbs-overlay">
					...
					<div class="breadcrumbs-text white-color">
							<h1 class="page-title">Own Parent Hospital</h1>
							<ul>
								<li>
									<a class="active" href="index.html">Why TPCON</a>
								</li>
								<li>Own Parent Hospital</li>
							</ul>
					</div>
			</div>
			<!-- Breadcrumbs End -->
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 order-last padding-0 md-pl-15 md-pr-15 md-mb-30">
							<div class="img-part">
								<img class="" src="image/hospital.jpg" alt="About Image">
							</div>
						</div>
						<div class="col-lg-6 pr-70 md-pr-15">
							<div class="sec-title">
								<div class="sub-title orange">Why TPCON</div>
						        <h3 class="title mb-17">Welcome to Teerthanker Parasvnath College of Nursing</h3>
								<div class="bold-text mb-22">Teerthanker Mahaveer Hospital, Moradabad.</div>
								<div class="desc">Teerthanker Parshvanath College Nursing is associated with its own parent hospital Teerthanker Mahaveer Hospital, Moradabad. The hospital is equipped with 1000 beds with exclusive 45 Emergency and casualty beds and 75 ICU beds. Teerthanker Mahaveer Medical College Hospital has widely expanded various clinical departments with a provision of super specialty care with growing spectrum of disease and increasing demand of such facilities. The Hospital is the apex health institution and provides tertiary care to the entire population of Moradabad and adjoining districts besides imparting clinical training to the students.<br>It houses the various clinical and para-clinical departments like Medicine, Psychiatry, Dermatology, Pulmonary Medicine, Pediatrics, General Surgery, Eye, ENT, Orthopedics, Gynae &Obs, Radiology and Anesthesia. It also has a well-developed Blood Bank and a Central lab for Pathology, Microbiology and Biochemistry. The diagnostic facilities like MRI, Spiral CT and Color Doppler are also available in the hospital.Over the period, Teerthanker Mahaveer Medical college Hospital has established a coronary care unit with Echocardiography, Holter, TMT, Image Intensifier and facilities for regular Angiography, Angioplasty, By-pass surgery & implantation of temporary and permanent pacemakers.There is one licensed Blood Bank in Teerthanker Mahaveer Medical College Hospital. The Blood Bank is well equipped and has facilities to prepare the blood components. It caters to the need of all the medical and surgical specialties and super specialties of the medical college Hospital.</div>
							</div>
						</div>
					</div>
				</div>
